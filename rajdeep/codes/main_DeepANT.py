...
def main():
    ...
    opt_dataset = {"n_steps":32, "training_data_folder" : "../data/yahoo_anomaly_data/training/", 
    ...
    "pool_strides_2": 2, "model_directory": "../models/", "model_name": "DeepANT", "batch_size": 256, "epochs": 500, "lr": 0.0001,
    "save_every": 100}
