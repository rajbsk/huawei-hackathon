...
from torch.nn import LSTM, Linear, Sigmoid, GRU, ReLU
...
class LSTMModel(nn.Module):
    def __init__(self, opt):
        ...
        self.hidden_layer = Linear(in_features = self.hidden_size, out_features=self.hidden_size)
    ...
    def forward(self, kpi_history, current_kpi):
        ...
        hidden_output = relu(self.hidden_layer(h))
